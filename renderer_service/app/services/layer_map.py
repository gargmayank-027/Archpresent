"""
app/services/layer_map.py

Config-driven layer-name -> semantic-role resolution. Ships with
sensible AIA-style defaults; a per-project override dict can be passed
in to handle offices with idiosyncratic naming, without any code
change. Ported unchanged from cad_service/layer_map.py.
"""
...
def _tokenize(name: str) -> set[str]:
    return set(t for t in _TOKEN_SPLIT_RE.split(name.upper()) if t)
